...
class GenreMovieDetailAdapter(private val genreResponse: MovieDetailResponse?,private val context: Context) : RecyclerView.Adapter<GenreMovieDetailAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.genre_item_movie_detail,parent,false)
